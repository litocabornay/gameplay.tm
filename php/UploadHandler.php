...
{  
	$add_to_db = $this->query("INSERT INTO gimages (`images`) VALUES
...
{  
	$delete_from_db = $this->query("DELETE FROM gimages WHERE images = '$delimg'") or die(mysql_error());  
