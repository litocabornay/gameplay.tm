...
<html>
    ...
    <body>
		...
		<p class="note">This example uses the <a href="http://365psd.com/day/3-58/">Elegant Login Form Design</a> psd.</p>

        <footer>
	        <h2><i>Tutorial:</i> Google Powered Login Form</h2>
            <a class="tzine" href="http://tutorialzine.com/2012/08/google-powered-login-form/">Head on to <i>Tutorial<b>zine</b></i> to read and download</a>
        </footer>
