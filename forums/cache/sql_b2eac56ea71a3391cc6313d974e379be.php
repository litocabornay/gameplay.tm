...
78483
a:1:{i:0;a:11:{s:8:"style_id";s:1:"2";s:8:"theme_id";s:1:"2";s:10:"theme_data";s:78069:"/*  phpBB3 Style Sheet
    --------------------------------------------------------------
	Style name:			DarkFX
...
body{
       background: url("{T_THEME_PATH}/images/lolwallpaper.jpg") no-repeat center center fixed; 
...
.cat-head {
	background: #252524 url("{T_THEME_PATH}/images/cat-head.png") repeat-x 50% 50%;
	-webkit-border-radius: 3px;
	-moz-border-radius: 3px;
	border-radius: 3px;
...
div.cat-title {
	background: transparent url("{T_THEME_PATH}/images/cat-title-r.png") no-repeat scroll top right; 
	float: left;
	height: 24px;
	padding-right: 12px;
	margin-top: 1px;
...
div.cat-title span {
	background: transparent url("{T_THEME_PATH}/images/cat-title-l.png") no-repeat; 
	display: block;
	padding-left: 11px;
	height: 24px;
}
...
.headtop {
	...
	background-image: url("{T_THEME_PATH}/images/headtop.gif");
...
.navmenu {
	...
	background-image: url("{T_THEME_PATH}/images/navmenu.gif");
	background-position: top;
	overflow: hidden;
	border-top: 1px solid #000;
	margin-bottom: 5px;
...
.navlink li {
	...
	margin: 0;
	padding: 0;
	background: url("{T_THEME_PATH}/images/navSplit.gif") no-repeat top right;
	float: left;
	padding-right: 2px;
}
...
width: 100%;
height: 17px;
background: url("{T_THEME_PATH}/images/sort-toggle.png") no-repeat top;
text-align: center;
margin-top: -5px;
}
...
* html hr { margin: 0; }
* html span.corners-top, * html span.corners-bottom { background-image: url("{T_THEME_PATH}/images/corners_left.png"); }
* html span.corners-top span, * html span.corners-bottom span { background-image: url("{T_THEME_PATH}/images/corners_right.png"); }
...
input.search {
	background-image: url("{T_THEME_PATH}/images/icon_search.png");
}

input.disabled {
	color: #d9d9d9;
}";s:10:"theme_path";s:6:"darkfx";s:10:"theme_name";s:6:"DarkFX";s:11:"theme_mtime";s:10:"1381141224";s:11:"imageset_id";s:1:"2";s:13:"imageset_name";s:6:"DarkFX";s:18:"imageset_copyright";s:60:"&copy; Abhishek Srivastava ( http://www.boardreloaded.com/ )";s:13:"imageset_path";s:6:"darkfx";s:13:"template_path";s:6:"darkfx";}}