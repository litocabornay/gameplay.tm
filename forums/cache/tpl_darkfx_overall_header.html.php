...
<head>
<?php $this->_tpldata['DEFINE']['.']['DARKFX_BOARD_WIDTH'] = '80%'; ?>
...
<title>gameplay.tm/forums</title>
...
<link rel="icon" type="image/png" href="http://www.gameplay.tm/favicon.ico"/>
...
<div class="pagetop"></div>	
	<div id="page-header">
	<div class="headtop"><div class="wrap2" style="width: <?php echo (isset($this->_tpldata['DEFINE']['.']['DARKFX_BOARD_WIDTH'])) ? $this->_tpldata['DEFINE']['.']['DARKFX_BOARD_WIDTH'] : ''; ?>;"><div class="logo-bg">

        <div class="frontLogo">
		
	<a href="../home.php"><img src="styles/darkfx/theme/images/logo.png" style="margin-top:40px"/></a>

        <p style="margin-left:50px; color:white;">W a t c h . &nbspP l a y . &nbspC o n q u e r .</p>
        </div>


	</div></div></div>	
	<div class="navmenu">
				<div class="wrap2" style="width: <?php echo (isset($this->_tpldata['DEFINE']['.']['DARKFX_BOARD_WIDTH'])) ? $this->_tpldata['DEFINE']['.']['DARKFX_BOARD_WIDTH'] : ''; ?>;"><div class="navlink"><ul>
				<li><a href="<?php echo (isset($this->_rootref['U_INDEX'])) ? $this->_rootref['U_INDEX'] : ''; ?>" accesskey="h">
					<strong><?php echo ((isset($this->_rootref['L_HOME'])) ? $this->_rootref['L_HOME'] : ((isset($user->lang['HOME'])) ? $user->lang['HOME'] : '{ HOME }')); ?></strong>
				</a></li>
				<li><a href="<?php echo (isset($this->_rootref['U_FAQ'])) ? $this->_rootref['U_FAQ'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_FAQ_EXPLAIN'])) ? $this->_rootref['L_FAQ_EXPLAIN'] : ((isset($user->lang['FAQ_EXPLAIN'])) ? $user->lang['FAQ_EXPLAIN'] : '{ FAQ_EXPLAIN }')); ?>">
					<strong><?php echo ((isset($this->_rootref['L_FAQ'])) ? $this->_rootref['L_FAQ'] : ((isset($user->lang['FAQ'])) ? $user->lang['FAQ'] : '{ FAQ }')); ?></strong>
				</a></li>
				<?php if (! $this->_rootref['S_IS_BOT'] && $this->_rootref['S_DISPLAY_MEMBERLIST']) {  ?>

				<li><a href="<?php echo (isset($this->_rootref['U_MEMBERLIST'])) ? $this->_rootref['U_MEMBERLIST'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_MEMBERLIST_EXPLAIN'])) ? $this->_rootref['L_MEMBERLIST_EXPLAIN'] : ((isset($user->lang['MEMBERLIST_EXPLAIN'])) ? $user->lang['MEMBERLIST_EXPLAIN'] : '{ MEMBERLIST_EXPLAIN }')); ?>">
					<strong><?php echo ((isset($this->_rootref['L_MEMBERLIST'])) ? $this->_rootref['L_MEMBERLIST'] : ((isset($user->lang['MEMBERLIST'])) ? $user->lang['MEMBERLIST'] : '{ MEMBERLIST }')); ?></strong>
				</a></li>
				<?php } if ($this->_rootref['S_DISPLAY_SEARCH']) {  ?>

				<li><a href="<?php echo (isset($this->_rootref['U_SEARCH'])) ? $this->_rootref['U_SEARCH'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_SEARCH_ADV_EXPLAIN'])) ? $this->_rootref['L_SEARCH_ADV_EXPLAIN'] : ((isset($user->lang['SEARCH_ADV_EXPLAIN'])) ? $user->lang['SEARCH_ADV_EXPLAIN'] : '{ SEARCH_ADV_EXPLAIN }')); ?>">
					<strong><?php echo ((isset($this->_rootref['L_SEARCH'])) ? $this->_rootref['L_SEARCH'] : ((isset($user->lang['SEARCH'])) ? $user->lang['SEARCH'] : '{ SEARCH }')); ?></strong>
				</a></li>
				<?php } if (! $this->_rootref['S_IS_BOT'] && $this->_rootref['S_USER_LOGGED_IN']) {  ?>

				<li><a href="<?php echo (isset($this->_rootref['U_PROFILE'])) ? $this->_rootref['U_PROFILE'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_PROFILE'])) ? $this->_rootref['L_PROFILE'] : ((isset($user->lang['PROFILE'])) ? $user->lang['PROFILE'] : '{ PROFILE }')); ?>" accesskey="e">
					<strong><?php echo ((isset($this->_rootref['L_PROFILE'])) ? $this->_rootref['L_PROFILE'] : ((isset($user->lang['PROFILE'])) ? $user->lang['PROFILE'] : '{ PROFILE }')); ?></strong>
				</a></li>
				<?php } if ($this->_rootref['S_DISPLAY_PM'] && ! $this->_rootref['S_IS_BOT'] && $this->_rootref['S_USER_LOGGED_IN']) {  ?>

				<li><a href="<?php echo (isset($this->_rootref['U_PRIVATEMSGS'])) ? $this->_rootref['U_PRIVATEMSGS'] : ''; ?>">
					<strong><?php echo (isset($this->_rootref['PRIVATE_MESSAGE_INFO'])) ? $this->_rootref['PRIVATE_MESSAGE_INFO'] : ''; ?></strong>
				</a></li>
				<?php } if ($this->_rootref['U_RESTORE_PERMISSIONS']) {  ?>

				<li><a href="<?php echo (isset($this->_rootref['U_RESTORE_PERMISSIONS'])) ? $this->_rootref['U_RESTORE_PERMISSIONS'] : ''; ?>">
				<strong><?php echo ((isset($this->_rootref['L_RESTORE_PERMISSIONS'])) ? $this->_rootref['L_RESTORE_PERMISSIONS'] : ((isset($user->lang['RESTORE_PERMISSIONS'])) ? $user->lang['RESTORE_PERMISSIONS'] : '{ RESTORE_PERMISSIONS }')); ?></strong>
				</a></li>
				...
				<li><a href="<?php echo (isset($this->_rootref['U_REGISTER'])) ? $this->_rootref['U_REGISTER'] : ''; ?>">
					<strong><?php echo ((isset($this->_rootref['L_REGISTER'])) ? $this->_rootref['L_REGISTER'] : ((isset($user->lang['REGISTER'])) ? $user->lang['REGISTER'] : '{ REGISTER }')); ?></strong>
				</a></li>	
				<?php } } if (! $this->_rootref['S_IS_BOT']) {  ?>				
				<li><a href="<?php echo (isset($this->_rootref['U_LOGIN_LOGOUT'])) ? $this->_rootref['U_LOGIN_LOGOUT'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_LOGIN_LOGOUT'])) ? $this->_rootref['L_LOGIN_LOGOUT'] : ((isset($user->lang['LOGIN_LOGOUT'])) ? $user->lang['LOGIN_LOGOUT'] : '{ LOGIN_LOGOUT }')); ?>" accesskey="x">
					<strong><?php echo ((isset($this->_rootref['L_LOGIN_LOGOUT'])) ? $this->_rootref['L_LOGIN_LOGOUT'] : ((isset($user->lang['LOGIN_LOGOUT'])) ? $user->lang['LOGIN_LOGOUT'] : '{ LOGIN_LOGOUT }')); ?></strong>
				</a></li>
				<?php } ?>
...
<div id="wrap3" style="width: <?php echo (isset($this->_tpldata['DEFINE']['.']['DARKFX_BOARD_WIDTH'])) ? $this->_tpldata['DEFINE']['.']['DARKFX_BOARD_WIDTH'] : ''; ?>;">	

	<div class="cat-head">
	<div class="cat-title"><span><a href="<?php echo (isset($this->_rootref['U_INDEX'])) ? $this->_rootref['U_INDEX'] : ''; ?>" accesskey="h"><?php echo ((isset($this->_rootref['L_INDEX'])) ? $this->_rootref['L_INDEX'] : ((isset($user->lang['INDEX'])) ? $user->lang['INDEX'] : '{ INDEX }')); ?></a></span></div><?php $_navlinks_count = (isset($this->_tpldata['navlinks'])) ? sizeof($this->_tpldata['navlinks']) : 0;if ($_navlinks_count) {for ($_navlinks_i = 0; $_navlinks_i < $_navlinks_count; ++$_navlinks_i){$_navlinks_val = &$this->_tpldata['navlinks'][$_navlinks_i]; ?><div class="cat-title" style="margin-left: 5px;"><span><a href="<?php echo $_navlinks_val['U_VIEW_FORUM']; ?>"><?php echo $_navlinks_val['FORUM_NAME']; ?></a></span></div><?php }} if ($this->_rootref['U_EMAIL_TOPIC'] || $this->_rootref['U_EMAIL_PM'] || $this->_rootref['U_PRINT_TOPIC'] || $this->_rootref['U_PRINT_PM']) {  ?><div style="float: right;">
